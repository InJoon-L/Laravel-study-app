...
<div class="flex justify-center h-screen items-center bg-gray-200 antialiased">
    <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-gray-300 shadow-xl">
      <div class="flex flex-col px-6 py-5 bg-gray-50">
        ...
        <div class="flex flex-row items-center justify-between p-5 bg-white border-gray-200 rounded shadow-sm">
            @if ($image)
        ...
        <div class="flex flex-row items-center justify-between p-5 bg-white border-t border-gray-200 rounded-bl-lg rounded-br-lg">
            <button wire:click="$emit('closeModal')"
                class="px-4 py-2 font-semibold text-white bg-green-500 rounded">Close</button>
            <button wire:click="$emit('update')"
                class="px-4 py-2 font-semibold text-white bg-blue-500 rounded">Save</button>
        </div>
      </div>
    </div>
</div>
